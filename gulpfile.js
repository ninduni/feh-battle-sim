...
var SOURCE_PATH = './src';
var VENDOR_PATH = SOURCE_PATH + '/vendor/';
 ...
 * Copies vendor scripts located in src/vendor
 */
function copyVendor() {
...
gulp.task('watch-js', ['fastBuild'], function() {
    browserSync.reload();
}); // Rebuilds and reloads the project when executed.
gulp.task('watch-static', ['copyVendor'], function() {
    browserSync.reload();
});
